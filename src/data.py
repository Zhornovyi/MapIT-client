...
PAY_TOKEN = environ.get("PAY_TOKEN", None)
...
class Data:
    ...
    def commit_interface_massages(self):
        ...
        table.free_answear_text = ["Дякуємо за вашу довіру! Ми проаналізували відповіді та рекомендуємо такі напрямки навчання 👇\n", 
        ...
        table.info_text = "Рекомендації з ІТ профорієнтації за результатими онлайн-тестуванням - 120 грн"
        table.save()
